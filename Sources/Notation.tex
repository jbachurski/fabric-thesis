...
\newnotation{tsubst}{$\subst{\tau}{\alpha}{\tau}$}{Type substitution}{A061}
...
\newnotation{asubst}{$\asubst$}{Substitution, e.g.\@ in $\substx{\asubst} e = e$}{T010}

\newcommand{\sch}{\sigma}
\newnotation{sch}{$\sch$}{Type scheme}{T010}
\newnotation{inst}{$\sigma \models \tau$}{Type scheme instantiation}{T011}

\newcommand{\rec}[1]{\mu\,{#1}\ldotp}
\newnotation{rec}{$\mu \alpha \ldotp \tau$}{Recursive type}{T020}
