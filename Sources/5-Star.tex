...
It turns out that \starr{}'s subtyping relation both forms a distributive lattice\todo{closure!}, and $\iota$ forms a type algebra isomorphism.
...
To display the features of \starr{} and its elegance in expressing common array programming patterns, we consider a case study of an array program -- and contrast to similar systems.\todo[color=red]{todo}
