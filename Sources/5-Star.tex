...
% Let us consider standard array programming terms, which \starr{} builds on and generalises.
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-expressions}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-values}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-broadcasting}
    \caption{
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-in-bounds}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-cast}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-opsem-err}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-opsem}
    \caption{
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-contexts}
...
\begin{figure}[t]
    \centering
    \input{Sources/5-Figures/Star-types}
...
\begin{table}[t]
    \centering
    \input{Sources/5-Figures/Star-shape-index-examples}
...
We move on to \starr{}'s type system, which features novel aspects matching the design of structural shape and index types. 
...
\begin{figure}[p]
    \centering
    \input{Sources/5-Figures/Star-subtyping}
    \caption{
...
\begin{figure}[p]
    \centering
    \input{Sources/5-Figures/Star-typing}
...
\begin{figure}
    \centering
    \input{Sources/5-Figures/Star-iota}
...
\begin{figure}
    ...
    \input{Sources/5-Figures/Star-constraints}
...
\input{Sources/5-Figures/Star-padding}
