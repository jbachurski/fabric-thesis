...
In fact, \inference{} has a polarity-restricted subset, in which all constraints are of form $\tau^+ \sub \tau^-$ and thus intermediate $\typcnf$ have single-literal clauses.
